...
void RH_RF95::validateRxBuf()
{
    ...
    _rxHeaderTo = ((uint32_t)_buf[0] << 24) | ((uint32_t)_buf[1] << 16) | ((uint32_t)_buf[2] << 8) | _buf[3];
    _rxHeaderFrom = ((uint32_t)_buf[4] << 24) | ((uint32_t)_buf[5] << 16) | ((uint32_t)_buf[6] << 8) | _buf[7];
...
bool RH_RF95::send(const uint8_t* data, uint8_t len)
{
    ...
    spiWrite(RH_RF95_REG_00_FIFO, (_txHeaderTo & 0xFF));
    ...
    spiWrite(RH_RF95_REG_00_FIFO, (_txHeaderFrom & 0xFF));
